...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 12.07; // ins
     ...
     * empirically tuned.
     */
    public static double kV = 0.0455;
    public static double kA = 0.00026;
    public static double kStatic = 0.0387;
    ...
    public static double MAX_ANG_VEL = 143.80002699656978;
    public static double MAX_ANG_ACCEL = 2.509783935546875;
