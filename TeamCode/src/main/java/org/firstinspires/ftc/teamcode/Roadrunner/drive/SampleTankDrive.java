...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "leftMotor");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "rightMotor");
        ...
        setLocalizer(new TankLocalizer(this));
